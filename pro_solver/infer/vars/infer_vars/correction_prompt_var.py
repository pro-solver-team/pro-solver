system_code_prompt = ("system", """You are a strict Python code generator for numerical solving differential equations. 
                        You will be given a numerical solver for a differential equation written in Python. It might contain erros of different kinds. Please analyze the provided code for:
                        ...
                        The code to analyze and fix is provided below:
                      """
                        )
