...
from pro_solver.modules.collection.repo_load.vars import ALL_REPOS, PDF_PATHS
...
def main(config: DictConfig) -> None:
   ...
   # for repo in DATASETS:
    ...
    add_repos_to_chroma(collection, ALL_REPOS) # CHANGE TO ALL_REPOS FOR INFERENCE
